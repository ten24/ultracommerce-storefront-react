...
import { CashPaymentDetails } from '../Review/CashPaymentDetails'
...
const PaymentList = ({ resetSelection }) => {
  ...
  const { CREDIT_CARD_CODE, GIFT_CARD_CODE, TERM_PAYMENT_CODE, CASH_PAYMENT_CODE } = useCheckoutUtilities()
